				...
				<div class="content">
					...
					<table border="1" class="myTable">
						<tr class="myTableRow">
							...
							<th class="myTableHead" input type="submit" value="Cancel"
								style="padding-right: 10px; text-align: center">Cancel</th>
						...
						<tbody>
							<c:forEach items="${repairerList}" var="mar" varStatus="status">
								<tr>
									...
									<td><form
											action="/Mac_Facility/RepairerController?action=cancelReservation&id=${mar.id}"
											method="post">
					...
					<br> 
					<input name="resultCancel" value="<c:out value='${resultCancel}'/>"
						type="text"
