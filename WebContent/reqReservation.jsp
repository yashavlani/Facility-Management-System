				...
				<div class="content">
					...
					<table border="1" class="myTable">
						<tr class="myTableRow">
							...
							<th class="myTableHead"
								style="padding-right: 10px; text-align: center">Status</th>
						...
						<tbody>
							<c:forEach items="${repairerList}" var="mar" varStatus="status">
								<tr>
									...
									<td><form
											action="/Mac_Facility/RepairerController?action=requestReservation&id=${mar.id}"
											method="post">
											<button type="submit" name="your_name" value="your_value"
												class="btn-link">Confirm</button>
										</form></td>
								</tr>
							</c:forEach>
						</tbody>
					...
					<br> <input name="resultRequest"
						value="<c:out value='${resultRequest}'/>" type="text"
